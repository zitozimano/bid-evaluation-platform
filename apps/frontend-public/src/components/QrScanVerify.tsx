...
export default function QrScanVerify() {
  ...
  async function handleVerify() {
    ...
    if (!trimmed) {
      setError("No hash detected. Paste or scan a QR code first.");
      return;
    }
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <p className="text-sm text-slate-400 mb-6">
        Scan the QR code printed on the evaluation pack or report. Paste the
        scanned hash or link below to verify it.
      </p>
      ...
      <div className="space-y-4">
        <div>
          ...
          <textarea
            ...
            rows={3}
            placeholder="Paste the scanned value here..."
